...
4. Example output using revised parameters for verbosity, output folder, etc.:
        ...
        c:\migrate\RMWorkflowMigrator.exe -n . -d ReleaseManagement -t "Fabrikam Call Center"  -s Dev -v -i -o Dev
...
6. The export process needs to be repeated for the other stages in the pipeline that need to be migrated
