// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IRMComponentRepository.cs" company="Microsoft Corporation">
...
// </copyright>
// <summary>
//   Defines the IRMComponentRepository interface.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Microsoft.ALMRangers.RMWorkflowMigrator.DataAccess.Interfaces
{
    ...
    public interface IRMComponentRepository
    {
        Task<RMComponent> GetComponentByIdAsync(Guid workflowGuid, int stageId);

        Task<IEnumerable<ConfigurationVariable>> GetComponentConfigurationVariablesAsync(Guid workflowGuid, int stageId);
    }
}
