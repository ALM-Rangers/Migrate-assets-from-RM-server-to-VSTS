// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IRMDeployerToolRepository.cs" company="Microsoft Corporation">
...
// </copyright>
// <summary>
//   Defines the IRMDeployerToolRepository interface.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Microsoft.ALMRangers.RMWorkflowMigrator.DataAccess.Interfaces
{
    ...
    public interface IRMDeployerToolRepository
    {
        Task WriteToolToDiskAsync(int deployerToolId, string diskPath);
    }
}