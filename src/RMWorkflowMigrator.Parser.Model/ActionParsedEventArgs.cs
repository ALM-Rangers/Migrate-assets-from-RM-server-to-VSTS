// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ActionParsedEventArgs.cs" company="Microsoft Corporation">
...
// </copyright>
// <summary>
//   Defines the ActionParsedEventArgs type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------

namespace Microsoft.ALMRangers.RMWorkflowMigrator.Parser.Model
{
    public class ActionParsedEventArgs : ContainerParsedEventArgs
    {
    }
}