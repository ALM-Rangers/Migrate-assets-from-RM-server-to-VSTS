// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnsupportedReleaseManagementVersionException.cs" company="Microsoft Corporation">
...
// </copyright>
// <summary>
//   Defines the UnsupportedReleaseManagementVersionException type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Microsoft.ALMRangers.RMWorkflowMigrator.CmdLine
{
    ...
    [Serializable]
    public class UnsupportedReleaseManagementVersionException : Exception
    {
        public UnsupportedReleaseManagementVersionException(string message) : base(message)
        {
        }
    }
}
