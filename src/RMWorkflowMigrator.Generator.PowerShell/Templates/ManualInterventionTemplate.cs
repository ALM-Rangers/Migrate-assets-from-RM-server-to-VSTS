...
if (manualIntervention.IsTargetGroup) {
            ...
            #line default
            #line hidden
            this.Write("\r\n#>\r\n# This manual intervention cannot be converted. Please see the guidance doc" +
                    "umentation for how to adapt your deployment process.");
...
/// <summary>
/// Access the manualIntervention parameter of the template.
/// </summary>
private global::Microsoft.ALMRangers.RMWorkflowMigrator.Generator.PowerShell.Model.ScriptManualIntervention manualIntervention
{
    get
    {
        return this._manualInterventionField;
    }
}
...
if ((manualInterventionValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "14.0.0.0")]
    public class ManualInterventionTemplateBase
    {
        #region Fields
